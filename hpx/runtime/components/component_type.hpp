...
//         ///////////////////////////////////////////////////////////////////////////
//         template <typename Component>
//         inline component_type get_component_type_impl(
//             typename traits::component_type_database<Component>::static_*)
//         {
...
//         inline component_type get_component_type_impl(...)
//         {
//             component_type type = traits::component_type_database<Component>::get();
//
//             if (type == component_invalid)
//             {
//                 type = detail::get_agas_component_type(
//                     get_component_name<Component>(),
//                     get_component_base_name<Component>());
//                 traits::component_type_database<Component>::set(type);
//             }
//
//             return type;
